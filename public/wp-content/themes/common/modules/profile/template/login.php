    ...
    <?php else: ?>
        ...
        <div class="col-md-6 mt-3 mt-md-0">
            <div class="register-links">
                ...
                <p><?php _e('Вы предоставляете услуги? Регистрируйтесь и позвольте нашим посетителям найти вас.', 'common'); ?></p>
                ...
                <p><?php _e('Вы ищете мастеров, дизайнеров, строителей? Регистрируйтесь, что бы получить полный доступ к сайту.', 'common'); ?></p>
