...
function pror_profile_get_error_message( $error_code ) {
    $codes = [
        ...
        'invalid_username' => __("Пользователь с таким Email не зарегистрирован. Возможно вы использовали другой Email при регистрации", 'common'),
        'existing_user_login' => sprintf( __("Пользователь с таким Email уже зарегистрирован. <a href='%s'>Войти</a> на сайт.", 'common'), wp_login_url() ),
        ...
        'expiredkey' => __( 'Ссылка для восстановления пароля устарела.', 'common' ),
        'invalidkey' => __( 'Ссылка для восстановления пароля устарела.', 'common' ),
        ...
        'user_tel' => __( 'Неправильный Рабочий телефон.', 'common' ),
