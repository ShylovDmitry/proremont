<?php
$cache_obj = pror_cache_obj(0, 'lang', 'pror:catalog_master:page', 'block');
...
<div class="catalog-master-page">
    <?php $pos = 0; ?>
    <?php foreach(pror_get_catalog(0, false) as $main_catalog): $pos++; ?>
        ...
        <div class="catalog-mater-item mb-4">
            ...
            <div class="catalog-subs row">
                <?php foreach (pror_get_catalog($main_catalog->term_id, false) as $sub_catalog): ?>
                    <div class="col-12"><a href="<?php echo esc_url( get_term_link($sub_catalog) ); ?>" title="<?php echo esc_attr($sub_catalog->name); ?>"><span><?php echo $sub_catalog->name; ?></span></a></div>
                <?php endforeach; ?>
            </div>
        </div>
