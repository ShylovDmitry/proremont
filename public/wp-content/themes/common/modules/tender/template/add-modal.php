    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createTenderResponseModal"><?php _e('Откликнуться на заявку', 'common'); ?></h5>
            ...
            <div class="modal-body">
                <form action="" id="create-tender-response">
                    ...
                    <div class="form-group">
                        <label for="tenderResponseComment">Комментарий</label>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="tenderResponseCommentVisibilityAll">
                                Все будут видеть ваш комментарий.
                            </label>
                        </div>
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="tenderResponseCommentVisibilityClientOnly">
                                Только клиент будет видеть ваш комментарий.
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-2">
                        ...
                        <button class="btn btn-pror-primary"><?php _e('Откликнуться', 'common'); ?></button>
                    </div>
                </form>
            </div>
        </div>
