    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Если Вам необходимо больше категорий, рассмотрите возможности <a href="https://proremont.co/pro-akkaunt-dlya-masterov/?utm_source=adminpanel&utm_medium=popup&utm_campaign=link" target="_blank">PRO-аккаунта</a> без ограничения по категориям. Узнайте все преимущества PRO-аккаунта, который позволит Вам привлечь максимальное число клиентов.</p>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <p>Для того, что бы подтвердить свой аккаунт, получить бейдж "Проверено" - <span class="oi oi-circle-check is-confirmed" data-toggle="tooltip" data-placement="top" title="Проверено"></span>, а значит,  и повысить доверие посетителей к своему профилю, Вам необходимо выполнить следующие действия:</p>
                <p>Позвонить нашему менеджеру с Вашего телефона (
                        ...
                        <?php endforeach; ?>
                    ) и подтвердить свои данные в телефонном режиме <i>(займет менее 1 минуты)</i>.</p>
...
<div class="modal fade" id="modalAboutReviews" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Наш сайт использует сложный алгоритм сортировки исполнителей и учитывает много переменных, в том числе - и заполненность Вашего профиля.</p>
                <p>Самый <strong>простой способ</strong> - это <a href="https://proremont.co/pro-akkaunt-dlya-masterov/?utm_source=adminpanel&utm_medium=popup&utm_campaign=empty_review" target="_blank">приобрести PRO-аккаунт</a>.</p>
